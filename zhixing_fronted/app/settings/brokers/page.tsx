...
import { RefreshCw, CheckCircle, XCircle, Loader2, ArrowLeft, Settings, History } from 'lucide-react';
          ...
          {!longbridgeConnected ? (
            <div className="space-y-6">
              <div className="bg-purple-50 dark:bg-purple-900/20 p-4 rounded-lg border border-purple-200 dark:border-purple-800">
                ...
                <ol className="list-decimal list-inside space-y-2 text-sm text-gray-700 dark:text-gray-300">
                  <li>访问长桥开放平台: <a href="https://open.longportapp.com" target="_blank" className="text-purple-600 underline">open.longportapp.com</a></li>
